...
(function () {
        ...
        '<div class="footer-top">' +
          ...
          '<div class="footer-col">' +
            ...
            '<ul class="footer-contact">' +
              ...
              '<li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg><a href="mailto:bdddesign@hotmail.com">bdddesign@hotmail.com</a></li>' +
            '</ul>' +
          '</div>' +
        '</div>' +
  ...
  var floatsHTML =
    '<div class="float-contact">' +
      '<a class="fc-line" href="' + LINE + '" target="_blank" rel="noopener" aria-label="LINE"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 5.64 2 10.13c0 4.02 3.55 7.39 8.35 8.03.32.07.77.21.88.49.1.25.07.65.03.91l-.14.86c-.04.25-.2 1 .87.54 1.08-.45 5.8-3.42 7.92-5.85C21.36 13.49 22 11.9 22 10.13 22 5.64 17.52 2 12 2zM8.2 12.6H6.16c-.3 0-.54-.24-.54-.54V8.5c0-.3.24-.54.54-.54.3 0 .54.24.54.54v3.02H8.2c.3 0 .54.24.54.54s-.24.54-.54.54zm2.13-.54c0 .3-.24.54-.54.54s-.54-.24-.54-.54V8.5c0-.3.24-.54.54-.54s.54.24.54.54v3.56zm4.34 0c0 .23-.15.44-.37.51a.6.6 0 0 1-.17.03c-.17 0-.33-.08-.43-.22l-1.86-2.53v2.21c0 .3-.24.54-.54.54s-.54-.24-.54-.54V8.5c0-.23.15-.44.37-.51.22-.08.46 0 .6.19l1.86 2.53V8.5c0-.3.24-.54.54-.54s.54.24.54.54v3.56zm3.04-2.32c.3 0 .54.24.54.54s-.24.54-.54.54h-1.5v.7h1.5c.3 0 .54.24.54.54s-.24.54-.54.54h-2.04c-.3 0-.54-.24-.54-.54V8.5c0-.3.24-.54.54-.54h2.04c.3 0 .54.24.54.54s-.24.54-.54.54h-1.5v.7h1.5z"/></svg></a>' +
